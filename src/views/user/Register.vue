    ...
    <a-form ref="formRegister" :form="form" id="formRegister">
      ...
      <a-form-item>
        <a-input
          ...
          type="text"
          placeholder="邮箱"
          v-decorator="['email', {rules: [{ required: true, type: 'email', message: '请输入正确的邮箱地址' }], validateTrigger: ['change', 'blur']}]"
        ></a-input>
      </a-form-item>
      ...
      <a-form-item>
        <a-input size="large" placeholder="12位或者13位学号" v-decorator="['studentNumber', {rules: [{ required: true, message: '请输入正确的学号', pattern: /^[1-9]([\d]{11}|[\d]{12})$/ }, { validator: this.handlePhoneCheck } ], validateTrigger: ['change', 'blur'] }]">
        </a-input>
      </a-form-item>
      <a-form-item>
